...
#bash pull.sh
java -server -XX:+UseConcMarkSweepGC -XX:+UseParNewGC -XX:+CMSIncrementalPacing -XX:ParallelGCThreads=5 -XX:+AggressiveOpts -Xms1G -Xmx6G -jar Thermos-1.7.10-1614-server.jar nogui
